...
public class Values extends Application {
    ...
    Hashtable<String, Double> dict_ring = new Hashtable<String, Double>() {
    ...
    Hashtable<String, Double> dict_multi = new Hashtable<String, Double>(){
    ...
    Hashtable<String, Double> dict_tole = new Hashtable<String, Double>(){
